export default [
  {
    ...
    body:
      "I want use NextJS with firebase cloud functions and I am creating a cloud function: import * as functions from 'firebase-functions'; import cors from 'cors'; import express from 'express'; import … = functions.https.onRequest(nextApp); NextJS create a folder with the build of my JS app. The problem is that I can't upload on the cloud the NextJS build folder. How I can include this folder? GitHub Issue => https://github.com/zeit/next.js/issues/2017",
    like_count: 0,
  ...
  },
  {
    id: 833,
    title:
      "Quantifying the matrix won't do anything, we need to index the virtual com interface!",
    body:
